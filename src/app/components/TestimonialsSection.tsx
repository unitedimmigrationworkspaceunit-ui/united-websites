...
const testimonials = [
  {
    ...
    rating: 5,
    text: "United Immigration made my Canada PR dream a reality! Their team guided me through every step of the Express Entry process. Within 8 months I had my PR in hand. Best investment I ever made for my future!",
    date: 'March 2026',
    flag: '🇨🇦',
  ...
  },
  {
    ...
    name: 'Rajesh Patel',
    role: 'Civil Engineer',
    destination: 'Australia — Skilled 189',
    city: 'Now in Melbourne 🇦🇺',
    image: indianPortraits.manProfessional,
    rating: 5,
    text: "Exceptional service from start to finish! Got my Australian skilled migration visa in just 6 months. The team prepared a flawless EOI that boosted my points significantly. Their expertise is unmatched!",
    date: 'February 2026',
    flag: '🇦🇺',
  ...
  },
  {
    ...
    rating: 5,
    text: "Living my dream of studying medicine in the UK! United Immigration secured my visa in just 3 weeks. They handled the CAS, finances, and every tiny detail. They're not consultants — they're dream-makers!",
    date: 'January 2026',
    flag: '🇬🇧',
  ...
  },
  {
    ...
    name: 'Amit Kumar',
    role: 'Data Scientist',
    destination: 'USA H1B Work Visa',
    city: 'Now in San Francisco 🇺🇸',
    image: indianPortraits.manYoung,
    rating: 5,
    text: "Successfully got my H1B visa approved! The documentation support was impeccable — they coordinated with my employer's attorney and handled the LCA filing perfectly. 100% recommended!",
    date: 'December 2025',
    flag: '🇺🇸',
  ...
  },
  {
    ...
    destination: 'Germany Opportunity Card',
    city: 'Now in Berlin 🇩🇪',
    image: indianPortraits.womanProfessional,
    rating: 5,
    text: "My Germany job seeker visa journey was smooth thanks to United Immigration. Expert advice on resume prep, German job market strategies, and the full visa process. Got a job offer within 3 months of landing in Berlin!",
    date: 'November 2025',
    flag: '🇩🇪',
...
const miniGrid = [
  { name: 'Vikram M.', text: 'Reunited with my parents in Canada — fast, hassle-free sponsorship!', flag: '🇨🇦', rating: 5, image: face(portraitIds.manCasual, 200), instagramUrl: 'https://www.instagram.com/unitedimmigrationservicespvt' },
  { name: 'Sunita R.', text: 'UK tourist visa in 5 days! Amazing team, zero stress, 100% transparent.', flag: '🇬🇧', rating: 5, image: face(portraitIds.womanSmiling, 200), instagramUrl: 'https://www.instagram.com/unitedimmigrationservicespvt' },
  { name: 'Rohan D.', text: 'From university admission to visa grant in 6 weeks. Now studying engineering in Melbourne!', flag: '🇦🇺', rating: 5, image: face(portraitIds.manYoung, 200), instagramUrl: 'https://www.instagram.com/unitedimmigrationservicespvt' },
];

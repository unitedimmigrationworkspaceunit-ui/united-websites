...
const features = [
  ...
  {
    icon: Award,
    title: 'Authorised Consultants',
    description: 'Recognised and authorised education consultants committed to transparent, ethical service',
  ...
  },
  {
    ...
    description: 'Experienced education counsellors and visa experts dedicated to your success',
    color: 'from-purple-500 to-pink-600',
  },
  {
    icon: HeadphonesIcon,
    title: 'Dedicated Support',
    description: 'Round-the-clock assistance via phone and WhatsApp throughout your journey',
    color: 'from-orange-500 to-red-600',
  },
  {
    icon: FileCheck,
    title: 'Documentation Help',
    description: 'Complete assistance with translations, attestations, and all required documentation',
    color: 'from-teal-500 to-cyan-600',
  },
  {
    icon: Globe2,
    title: 'End-to-End Support',
    description: 'From university selection to pre-departure guidance — we are with you every step',
    color: 'from-indigo-500 to-blue-600',
  },
  {
    icon: Zap,
    title: 'Transparent Process',
    description: 'No hidden costs, clear timelines, and honest guidance at every stage',
